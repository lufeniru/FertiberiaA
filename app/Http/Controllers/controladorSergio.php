...
class controladorSergio extends Controller
{
   function vercompuestos(Request $req) {
    ...
    function verelementos(Request $req) {
        ...
        $tabla=DB::select("SELECT tabla_tocha.fechahora,tabla_tocha.id_elemento,tabla_tocha.valor1,tabla_tocha.valor2,tabla_tocha.simbolo,tabla_tocha.lectura,tabla_tocha.condicion,elementos.orden,datos_elementos.describe_elemento
        ...
        $ngranu=DB::select("SELECT COUNT(`id_granu`) as ngran FROM granudatos WHERE granudatos.id_granu='G1'");
